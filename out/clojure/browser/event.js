...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj5056 = {};return obj5056;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3613__auto__ = this$;if(and__3613__auto__)
...
{var x__4252__auto__ = (((this$ == null))?null:this$);return (function (){var or__3625__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4252__auto__)]);if(or__3625__auto__)
{return or__3625__auto__;
} else
{var or__3625__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3625__auto____$1)
...
return (function (p__5057){var vec__5058 = p__5057;var k = cljs.core.nth.call(null,vec__5058,(0),null);var v = cljs.core.nth.call(null,vec__5058,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__5059){var vec__5060 = p__5059;var k = cljs.core.nth.call(null,vec__5060,(0),null);var v = cljs.core.nth.call(null,vec__5060,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
